...
def get_superior_userid(weibo):
    ...
    #print 'weibo_r_uid:', weibo['retweeted_uid']
    ...
    if not repost_chains==[]:
        ...
        if direct_superior_id=='0' or direct_superior_id=='':
            print 'error!!!'
            print 'error direct_superior_id:', direct_superior_id
        if not direct_superior_id:
            direct_superior_id = find_by_scripy(direct_superior_name) # 爬取
        #print 'direct_superior_id:', direct_superior_id
        #print 'direct_superior_name', direct_superior_name.encode('utf-8')
        if direct_superior_id==None:
            file_name = 'fix_uname.txt'
