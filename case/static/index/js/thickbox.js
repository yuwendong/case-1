...
function showMsg(html, t, w, h) {	
	...
	TB_WIDTH = w || 400; //defaults to 630 if no paramaters were added to URL

	TB_HEIGHT = h || 300; //defaults to 440 if no paramaters were added to URL
	...
	var botton = "<div style='border-top:1px solid #c1d9ff;padding:5px;text-align:right'> <input value='确 定'  class='submit' type='submit' onclick='tb_remove()' style='width:70px;font-weight:bold'>   </div>";	

	

	$("#TB_window").append("<div id='TB_title'><div id='TB_ajaxWindowTitle'>"+title+"</div><div id='TB_closeAjaxWindow'><a href='#' id='TB_closeWindowButton' title='Close'>&nbsp; &nbsp; &nbsp; &nbsp;</a></div></div><div style='padding:10px; width:"+ajaxContentW+"px;height:"+ajaxContentH+"px;overflow-y:auto'>"+html+"</div>" + botton);
