...
def get_neighbor_info(topic, date, windowsize, uid, network_type):
    ...
    #获取邻居节点的信息
    neighbor_info, top_keyword, sentiment_dict = get_info(neighbor_list)
    
    return neighbor_info, top_keyword, sentiment_dict
...
def get_info(neighbor_list):
    ...
    return sort_neighbor_info, sort_top_keyword, new_sentiment_list
